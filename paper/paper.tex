...
\begin{list}{-}{}
    ...
    \item \textbf{numerical point cloud sampling of the variety:} a large set of numerical solutions that sample the variety, which can be used to understand its structure and properties.
\end{list}

% nice possible graphic: a diagram showing the relationships and transitions between different types of solutions (numerical, symbolic, parametric, etc.), this flowchart could very nicely illustrate the whole story of the paper.
